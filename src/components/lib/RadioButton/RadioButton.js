...
export default class RadioButton extends Component {
  ...
  getRadioStyle() {
    return {
      ...
      borderColor: this.props.isSelected && this.props.activeColor ? this.props.activeColor : this.props.borderColor || this.context.color
    };
  }
  ...
  render() {
    ...
    return (
      <View style={{ opacity: this.props.disabled ? 0.4 : 1 }}>
        <TouchableWithoutFeedback disabled={this.props.disabled} onPress={() => this.context.onSelect(this.props.index, this.props.value)}>
