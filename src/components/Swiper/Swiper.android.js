...
export default class extends Component {
  ...
  renderScrollView = pages => {
    ...
    // }
    // return (
    //   <ViewPagerAndroid ref={this.refScrollView} {...this.props} initialPage={this.props.loop ? this.state.index + 1 : this.state.index} onPageSelected={this.onScrollEnd} key={pages.length} style={[styles.wrapperAndroid, this.props.style]}>
    //     {pages}
    //   </ViewPagerAndroid>
    // );
  };
