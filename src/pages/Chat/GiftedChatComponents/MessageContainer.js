...
export default class MessageContainer extends React.Component {
  ...
  onScroll = ({ contentOffset }) => this.setState({ scrollY: contentOffset.y });
  ...
  refreshMessages = () => {
    this.scrollTo({ y: this.state.scrollY + 1, animated: true });
    this.scrollTo({ y: this.state.scrollY, animated: true });
  };
